...
⚠️ Невидимая метка правá не даёт. Просьба «добавить незаметную маркировку,
чтобы не было проблем с правами» выполнена как происхождение (невидимое) ПЛЮС
подпись там, где её требует лицензия (видимая). Одно без другого — аккуратно
задокументированное нарушение.
