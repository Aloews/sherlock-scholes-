...
|---|---|---|
| `/` | `HomeScreen` | **список игр**: Футбольный Элиас, ближайшие матчи, дайджест, арена на двоих, фэнтези, «Угадай игрока». Действия самого Элиаса — режим и вход в комнату — на шаг внутрь (`view === 'alias'`) |
