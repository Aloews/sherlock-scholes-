-- Duplicate cards cleanup (88 pairs from --find-dups, ratio >= 0.85).
...
-- score 0.93: keep «Кристиан Рамирес» [player | pv=115 | photo=y] — drop «Кристиан Рамирез» [pv=2 | photo=n]
...
-- score 0.92: keep «Эсекьель Барко» [player | pv=74372 | photo=y] — drop «Эзекьель Барко» [pv=297 | photo=y]
...
-- score 0.92: keep «Кайо Панталеан» [player | pv=11936 | photo=y] — drop «Кайо Панталеао» [pv=8380 | photo=y]
-- UPDATE cards SET active = false WHERE id = '9307736f-2070-4051-8031-428f4dafdfc0';  -- «Кайо Панталеао»
...
-- score 0.89: keep «Фабиан Шер» [player | pv=42 | photo=y] — drop «Фабиан Шэр» [pv=None | photo=y]
...
-- score 0.87: keep «Самюэль Это'о» [player | pv=1098 | photo=y] — drop «Самюэль Это’о» [pv=563 | photo=y]
-- UPDATE cards SET active = false WHERE id = 'afcd279f-97d0-4aec-ba23-524d00a97065';  -- «Самюэль Это’о»
...
-- score 0.86: keep «Эдерсон» [player | pv=537 | photo=y] — drop «Эмерсон» [pv=1008 | photo=n]
-- UPDATE cards SET active = false WHERE id = 'bad1eb0a-d8c8-4c82-bd0f-671dcd193681';  -- «Эмерсон»
-- score 0.86: keep «Алемания» [club | pv=1349 | photo=y] — drop «Алания» [pv=74961 | photo=n]
...
--   score 0.87: «Лига чемпионов УЕФА» [trophy] cf275ec1-5e0b-45d5-93bc-427fb0dbef90  <->  «Лига Чемпионов» [term] d404d700-3835-4ef2-ba30-52b401784dcc
