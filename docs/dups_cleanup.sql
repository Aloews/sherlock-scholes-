...
-- ============================================================================
-- 2026-07-26 — 3 ранее отложенных «тёзочных» дубля, подтверждены данными  [ПРИМЕНЕНО]
--
-- В прошлый раз (2026-07-25) их исключили из авто-дедупа как риск тёзки. После
-- daily-enrich данные прояснились — все три оказались дублями, НЕ разными
-- людьми, поэтому деактивированы (active=false, keep — более полная карточка):
--   Луис Суарес     eaf9ca1b  → дубль «Луис Альберто Суарес» (enrichment залил
--                               Barcelona/Ajax/Liverpool/Inter Miami — уругваец
--                               1987, а НЕ легенда Мирамонтес).
--   Нико Гонсалез   15e0701d  → дубль «Нико Гонсалес» (Порту/Ман Сити, 2002).
--   Родриго         afd71c0f  → дубль «Родриго Морено Машадо» (Валенсия/Лидс,
--                               1991; Rodrygo здесь ни при чём — у того ru-имя
--                               «Родригу»).
UPDATE cards SET active = false WHERE id IN (
  'eaf9ca1b-6f4a-44d3-85c3-f03febb373b5',
  '15e0701d-097b-48db-9867-2e8c67d8cf83',
  'afd71c0f-16b2-4e71-a8a8-1e0a45fe18c4'
);
