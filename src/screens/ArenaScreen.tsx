 ...
 * взята буквально. Сетевой вариант, где два телефона считают физику
 * синхронно, требует 60 обменов в секунду и держится на задержке в единицы
 * миллисекунд; в docs/VIDEOCHAT_HANDOFF.md записано измерение этого проекта —
 * 150–300 мс между континентами. Такую игру нельзя сделать «попозже
 * получше»: она либо идёт по локальной сети, либо не идёт. Поэтому телефон
 * кладут между двумя людьми, как и всё остальное в этом приложении.
 *
  ...
  return (
    <div className="min-h-screen bg-brand-bg ds-screen flex flex-col">
      ...
      {/* Управление. Левая половина — левой команде, правая — правой: телефон
          ...
          рукой. */}
      <div className="mt-auto flex items-stretch gap-2 px-2 pb-4">
        <ArenaPad
          side="left"
